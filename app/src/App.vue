    ...
    data() {
        return {
            ...
            fullStyle: [
                `/*
* Hi。贝贝！
* 今天情人节，恰逢机会简单介绍一下我的工作呢！
* 我是个后端java工程师。俗称程序员，大部分时间就是在赋值粘贴。
* 如这个前端项目。就是我在网站上复制的。（但是花费很长时间修改与部署T T）
* 我的工作就是给这种空白的页面加点儿东西。
* 嗯。说起来手机和电脑还得区分一下。
* 你现在用的是。。。${isPc ? '电脑' : '手机'}
*/
...
2025年02月12日。初次添加微信，恰逢元宵，感谢你给我这次机会。  
2025年02月13日。我开始逐步了解你，抽空为你准备这个礼物。
2025年02月14日。期待与你度过未来的每一天！
已有 \`${getDateDiff((new Date()).getFullYear()+'-'+((new Date()).getMonth()+1)+'-'+(new Date()).getDate(),'2025-02-12') + 1}\` 天
...
> 【Screw the world×I have my dear Beibei】  
